...
/* VOID:ENUM,STRING (marshal.list:24) */
void
_common_marshal_VOID__ENUM_STRING (GClosure     *closure,
...
/* VOID:INT,ENUM,STRING (marshal.list:25) */
void
_common_marshal_VOID__INT_ENUM_STRING (GClosure     *closure,
                                       GValue       *return_value G_GNUC_UNUSED,
                                       guint         n_param_values,
                                       const GValue *param_values,
                                       gpointer      invocation_hint G_GNUC_UNUSED,
                                       gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__INT_ENUM_STRING) (gpointer data1,
                                                      gint arg1,
                                                      gint arg2,
                                                      gpointer arg3,
                                                      gpointer data2);
  GCClosure *cc = (GCClosure *) closure;
  gpointer data1, data2;
  GMarshalFunc_VOID__INT_ENUM_STRING callback;
