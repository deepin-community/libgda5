...
**    gda_lemon_mysql_parserTOKENTYPE     is the data type used for minor tokens given 
**                       directly to the parser from the tokenizer.
**    YYMINORTYPE        is the data type used for all minor tokens.
**                       This is typically a union of many types, one of
**                       which is gda_lemon_mysql_parserTOKENTYPE.  The entry in the union
**                       for base tokens is called "yy0".
**    YYSTACKDEPTH       is the maximum depth of the parser's stack.  If
**                       zero the stack is dynamically sized using realloc()
**    gda_lemon_mysql_parserARG_SDECL     A static variable declaration for the %extra_argument
**    gda_lemon_mysql_parserARG_PDECL     A parameter declaration for the %extra_argument
**    gda_lemon_mysql_parserARG_STORE     Code to store %extra_argument into yypParser
**    gda_lemon_mysql_parserARG_FETCH     Code to extract %extra_argument from yypParser
...
#define gda_lemon_mysql_parserTOKENTYPE GValue *
typedef union {
  int yyinit;
  gda_lemon_mysql_parserTOKENTYPE yy0;
  GSList * yy33;
  CaseBody yy51;
  gboolean yy100;
  GSList* yy105;
...
#endif
#define gda_lemon_mysql_parserARG_SDECL GdaSqlParserIface *pdata;
#define gda_lemon_mysql_parserARG_PDECL ,GdaSqlParserIface *pdata
#define gda_lemon_mysql_parserARG_FETCH GdaSqlParserIface *pdata = yypParser->pdata
#define gda_lemon_mysql_parserARG_STORE yypParser->pdata = pdata
#define YYNSTATE 361
#define YYNRULE 196
#define YYFALLBACK 1
...
struct yyParser {
  ...
  gda_lemon_mysql_parserARG_SDECL                /* A place to hold %extra_argument */
#if YYSTACKDEPTH<=0
...
** None.
*/
void gda_lemon_mysql_parserTrace(FILE *TraceFILE, char *zTracePrompt){
...
** to gda_lemon_mysql_parser and gda_lemon_mysql_parserFree.
*/
void *gda_lemon_mysql_parserAlloc(void *(*mallocProc)(size_t)){
  yyParser *pParser;
...
static void yy_destructor(
  ...
  gda_lemon_mysql_parserARG_FETCH;
  switch( yymajor ){
...
**       obtained from gda_lemon_mysql_parserAlloc.
** <li>  A pointer to a function used to reclaim memory obtained
**       from malloc.
** </ul>
*/
void gda_lemon_mysql_parserFree(
...
*/
#ifdef YYTRACKMAXSTACKDEPTH
int gda_lemon_mysql_parserStackPeak(void *p){
  yyParser *pParser = (yyParser*)p;
...
#line 1728 "parser.c"
   gda_lemon_mysql_parserARG_STORE; /* Suppress warning about unused %extra_argument var */
}
...
static void yy_parse_failed(
  ...
  ** parser fails */
  gda_lemon_mysql_parserARG_STORE; /* Suppress warning about unused %extra_argument variable */
}
...
** "gda_lemon_mysql_parserAlloc" which describes the current state of the parser.
...
** None.
*/
void gda_lemon_mysql_parser(
  void *yyp,                   /* The parser */
  int yymajor,                 /* The major token code number */
  gda_lemon_mysql_parserTOKENTYPE yyminor       /* The value for the token */
  gda_lemon_mysql_parserARG_PDECL               /* Optional %extra_argument parameter */
){
  ...
  gda_lemon_mysql_parserARG_STORE;
